...
import {SelectCheckboxInputComponent} from "./selectCheckboxInput.component";
import {MatCheckbox, MatCheckboxModule} from "@angular/material/checkbox";

describe('SelectCheckboxInputComponent', () => {
  ...
  it('sendStyles', ( async() => {
    const fixture = TestBed.createComponent(SelectCheckboxInputComponent);
